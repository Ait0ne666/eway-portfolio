...
class BookingView extends StatefulWidget {
  ...
  const BookingView({Key? key, required this.booking}) : super(key: key);
...
class _BookingViewState extends State<BookingView>
  ...
  void charge(BuildContext context) {
    BlocProvider.of<ChargeBloc>(context)
        .add(StartCharge(pointId: widget.booking.pointId));
  }

  void chargeListener(BuildContext context, ChargeState state) {
    if (state is ChargeInProgressState &&
        state.progress?.pointId == widget.booking.pointId) {
      BlocProvider.of<PointInfoBloc>(context)
          .add(ShowPoint(pointId: widget.booking.pointId));
    }
  }
          ...
          child: Column(
            children: [
              BlocListener<ChargeBloc, ChargeState>(
                  listener: chargeListener, child: const SizedBox()),
              Container(
                height: 101,
                    ...
                    child: Column(
                      children: [
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          widget.booking.pointId.toString(),
                                          style: TextStyle(
                                            fontSize: 16,
                                            fontFamily: 'Benzin',
                                            foreground: Paint()
                          ...
                          children: [
                            Flexible(
                              ...
                              child: LabeledBox(
                                  ...
                                  paddingRight: 5,
                                  text: Text(
                                    mapVoltageToString(widget.booking.voltage),
                                    style:
                        ...
                        CustomButton(
                          ...
                          onPress: () => buildRoute(
                              context,
                              Coords(widget.booking.latitude,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          timeFromNow(widget.booking.time),
                          style: const TextStyle(
                              color: Color(0xff1A1D21),
                              fontSize: 15,
                              fontFamily: 'Circe'),
